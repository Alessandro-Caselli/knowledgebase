...
import {
  BookOpen, Search, LayoutDashboard, FolderOpen, Shield,
  Users, Settings, LogOut, ChevronRight, Plus, FileText
} from 'lucide-react';
...
const adminItems: NavItem[] = [
  { href: '/dashboard/admin/users', label: 'Users', icon: <Users size={18} />, adminOnly: true },
  { href: '/dashboard/admin/permissions', label: 'Permissions', icon: <Shield size={18} />, adminOnly: true },
];
      ...
      <div className="px-4 py-4 border-t border-slate-800">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-500 truncate capitalize">{session?.user?.role || 'viewer'}</p>
          </div>
        </div>
        <button
